                        ...
                        <div class="about-three__left">
                            ...
                            <ul class="about-three__points list-unstyled">
                                <li>
                                    <div class="icon">
                                        <div class="about-three__points-icon-shape"
                                            style="background-image: url('images/shapes/about-three-points-icon-shape.png');">
                                        </div>
                                ...
                                <li>
                                    <div class="icon">
                                        <div class="about-three__points-icon-shape"
                                            style="background-image: url('/src/assets/images/shapes/about-three-points-icon-shape.png');">
                                        </div>
                            ...
                            <div class="about-three__btn-and-user-box">
                                ...
                                <div class="about-three__user-info">
                                    <div class="about-three__user-img">
                                        <img src="images/resources/about-user-user-img.jpg" alt="">
                                    </div>
                    ...
                    <div class="col-xl-6">
                        <div class="about-three__right">
                            <div class="about-three__img"
                                style="background-image: url('images/shapes/about-three-img-shape-1.png');"></div>
